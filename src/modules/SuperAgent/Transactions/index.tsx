  ...
  const statData = [
    {
      ...
      value: formatToCurrency(
        transactionDetails?.data?.totalTransactionValue ?? 0
      ),
      percentage: getPercentageChange(
        parseInt(transactionDetails?.data?.totalTransactionValue),
        parseInt(transactionDetails?.data?.totalTransactionValueLastMonth)
      )?.percentageChange,
    },
    {
      id: 2,
      ...
      value: formatToCurrency(transactionDetails?.data?.totalClaimValue ?? 0),
      percentage: getPercentageChange(
        parseInt(transactionDetails?.data?.totalClaimValue),
        parseInt(transactionDetails?.data?.totalClaimValueLastMonth)
      )?.percentageChange,
    },
    {
      id: 3,
      ...
      value: formatToCurrency(
        transactionDetails?.data?.totalRemittanceValue ?? 0
      ),
      percentage: getPercentageChange(
        parseInt(transactionDetails?.data?.totalRemittanceValue),
        parseInt(transactionDetails?.data?.totalRemittanceValueLastMonth)
      )?.percentageChange,
    },
  ]
