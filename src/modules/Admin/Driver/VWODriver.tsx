...
const columns: ColumnDef<any>[] = [
  {
    ...
    header: ({ column }) => (
      ...
      >
        Driver ID <Icon as={BiSort} color="brand.primary" />
      </Button>
    ),
  },
  {
  ...
  {
    accessorKey: "DriverHouseNumber",
    header: "House Number",
  },
  {
    accessorKey: "DriverStreetName",
    header: "Street Name",
  },
  {
    ...
    <Box bgColor="brand.bgLight" alignItems="center" p="25">
      <Flex alignItems="center" justifyContent="space-between">
        <Heading fontSize="20px" color="#0B1023">
          All Properties Verified with Owners
        </Heading>
        <Spacer />
