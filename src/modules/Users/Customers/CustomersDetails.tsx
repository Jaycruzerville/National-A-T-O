...
const CustomerDetails = () => {
  ...
  const { data: customerDetails } = useQuery({
    ...
    queryFn: usersService.getCustomerDetails,
  ...
  const { data: customerTransactions } = useQuery({
    ...
    queryFn: usersService.getCustomersTransactions,
    onError: (error: IError) => {
      toast({
        title: "Error",
        description: error?.message,
  ...
  const { data: customerPlans, isLoading: loadingPlans } = useQuery({
    ...
    queryFn: usersService.getCustomerPlans,
    enabled: tabIndex === 1,
    onError: (error: IError) => {
      toast({
        title: "Error",
  ...
  const { data: customerClaims, isLoading: loadingClaims } = useQuery({
    ...
    queryFn: usersService.getCustomerClaims,
    enabled: tabIndex === 2,
    onError: (error: IError) => {
      toast({
        title: "Error",
